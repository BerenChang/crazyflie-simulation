...
#  XY Position PID
ctrl.kp_xy = 0.0  # 0.4       # P
ctrl.kd_xy = 0.0  # 0.2       # D
ctrl.ki_xy = 0.0  # 0.05      # I
ctrl.i_range_xy = 0.0 #  2.0

#  Z Position done
ctrl.kp_z = 100  #  1.25       # P
ctrl.kd_z = 50  #  0.4        # D
ctrl.ki_z = 0.0  #  0.5       # I
ctrl.i_range_z  = 0.0  #  0.4

#  Attitude
ctrl.kR_xy = 0.0  #  70000  # 70000, # P
ctrl.kw_xy = 0.0  #  20000  # 20000, # D
ctrl.ki_m_xy = 0.0 # I
ctrl.i_range_m_xy = 0.0  #  1.0

#  Yaw done
ctrl.kR_z = 0.0 # 60000  # 60000, # P
ctrl.kw_z = 0.0  # 12000  # 12000, # D
...
while robot.step(timestep) != -1:
    ...
    scaling = 1 # 1000 ##Todo, remove necessity of this scaling (SI units in firmware)
